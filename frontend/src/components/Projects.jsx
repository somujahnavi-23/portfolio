        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {projects.map((p, i) => (
            <motion.div
              ...
              className="group relative bg-[#0c0c0c] border border-white/10 p-8 sm:p-10 hover:border-volt/50 transition-colors overflow-hidden"
            ...
            >
              ...
              <p className="text-zinc-400 leading-relaxed text-[15px] mb-6">{p.description}</p>
